...
var controllers = [{
	...
	photographed: true,
	urls: {
		"https://www.youtube.com/watch?v=e_fXYlOV4-M": "Sharkie's Review",
	},
	cost: 10,
	...
	type: "3d",
	cost: 0,
	description: "2 triggers, 2 dpads, 4 buttons, dual 384×224 (black + 3 shades of red) monochrome LCDs. Gift from Exophase",
	games: "Virtual Boy",
},{
	peripheral: "000-14-A",
	company: "Sony",
	...
	attached: "000-14-A",
	company: "Sony",
	peripheralName: "PocketStation (Black)",
	systems: "PS1",
	obtained: "2025-04-19",
	cost: 50,
	importOnly: true,
	...
	cost: 30,
	importOnly: true,
	description: "1 dpad, 4 buttons, IRDA link, Pedometer, Reset, speaker, LCD can display 3 colors (+off) at a time, a cool box, unknown resolution color LCD. Came with a game",
	...
	systems: "Saturn",
	urls: {
		"https://www.youtube.com/watch?v=XSaOLOGyLi8": "Sharkie's Review",
	},
	location: "BIN-08 (Long)",
	photographed: true,
	cost: 40,
	description: "1 dpad, 2 triggers, 7 buttons (6 face, 1 system), 1 analog stick thing, a cool box. The switch toggles between the analog stick or dpad. Only one can be active at a time. Cost included the game, $20 without it",
	...
	type: "fighter",
	urls: {
		"https://www.youtube.com/watch?v=jV6br3dH9lQ": "Sharkie's Review",
	},
	photographed: true,
	cost: 20,
	...
	urls: {
		"https://www.youtube.com/watch?v=_QMjRfYeego": "Sharkie's Review",
	},
	systems: "PC",
	type: "gun,mouse",
	location: "BIN-16",
	...
	systems: "PS2",
	urls: {
		"https://www.youtube.com/watch?v=aW0CkpFP-s8": "Sharkie's Review",
	},
	obtained: "2006-12-20",
	photographed: true,
	cost: 300,
	...
	systems: "PS2",
	urls: {
		"https://www.youtube.com/watch?v=u1JB1g2tFCI": "Sharkie's Review",
	},
	obtained: "2007-01-08",
	photographed: true,
	type: "proplica",
	...
	cost: 60,
	urls: {
		"https://shonumi.github.io/articles/art21.html": "Edge of Emulation",
	},
	importOnly: true,
	...
	peripheral: "00X-11",
	company: "ASCII",
	peripheralName: "Resident Evil / Biohazard Pad SLEH-00011",
	systems: "PS1",
	urls: {
		"https://www.youtube.com/watch?v=ZrJYIULQvb0": "Sharkie's Review",
	},
	obtained: "2008-02-29",
	photographed: true,
	importOnly: true,
	...
	cost: 20,
	urls: {
		"https://www.youtube.com/watch?v=_OjM0diy21Y": "Sharkie's Review", 
	},
	...
	cost: 15,
	urls: {
		"https://www.youtube.com/watch?v=bc_qPz9FL_c": "Sharkie's Review", 
	},
	...
	systems: "GCN",
	urls: {
		"https://www.youtube.com/watch?v=YCxi6wRKSQE": "Sharkie's Review",
	},
	location: "BIN-08 (Long)",
	photographed: true,
	cost: 20,
	...
	systems: "PS2",
	urls: {
		"https://www.youtube.com/watch?v=NzlLgIdsuz8": "Sharkie's Review",
	},
	photographed: true,
	location: "BIN-11 (Site B)",
	cost: 20,
	...
	company: "Nintendo",
	peripheralName: "Zapper",
	location: "BIN-12 (Site B)",
	type: "gun",
	systems: "Wii",
	photographed: true,
	cost: 10,
	description: `A wiimote shell with 1 trigger`,
},{
	peripheral: "00Y-06",
	company: "Nintendo",
	...
	systems: "PS1",
	urls: {
		"https://www.youtube.com/watch?v=YxhoyKHMcEg": "Sharkie's Review",
	},
	photographed: true,
	obtained: "2009-02-27",
	cost: 5,
	...
	cost: 20,
	urls: {
		"https://www.youtube.com/watch?v=U-zK8E5a5a0": "Sharkie's Review",
	},
	...
	systems: "PS1",
	urls: {
		"https://www.youtube.com/watch?v=kZDKr51Uh6E": "Sharkie's Review",
	},
	photographed: true,
	cost: 25,
	importOnly: true,
	...
	photographed: true,
	cost: 0,
	description: `a card reader with built-in memory to store the content
	Cards I have:
	• Pokémon Channel: The Pikachu Star (Line Art), The Kyogre Constellation (Line Art), Poké A La Card (Paint Pattern)
	• Pokémon Ruby/Sapphire: Eon Ticket, Gentleman Nils (Battle)
	• NES Games: Urban Champion, Tennis, Golf, Donkey Kong 3, Clu Clu Land, Baseball, Balloon Fight
	• e-mazing shows are on the Fox Box: Do the Kirby Slide
	Missing:
	• NES Games: Donkey Kong, Donkey Kong 3, Excitebike, Ice Climber, Mario Bros., Pinball
	`,
	games: "GBA e-Reader",
},{
	peripheral: "063",
	...
	cost: 60,
	urls: {
		"https://www.youtube.com/watch?v=3vO0CE9FTtE": "Sharkie's Review", //SplitFish FragFX Shark (PlayStation 3 / PC & MAC)",
	},
	...
	cost: 60,
	urls: {
		"https://www.youtube.com/watch?v=K5T6vzBEpDU": "Sharkie's Review",
	},
	...
	systems: "Wii",
	urls: {
		"https://www.youtube.com/watch?v=NBCDXoDo73o": "Sharkie's Review",
	},
	obtained: "2009-05-14",
	photographed: true,
	cost: 30,
	...
	obtained: "2009-05-23",
	urls: {
		"https://www.youtube.com/watch?v=8dvCrYtTPcM": "Sharkie's Review",
	},
	photographed: true,
	cost: 20,
...
a switch to select if No sticks, the left stick, or the right stick is digital`,
	...
	cost: 60,
	urls: {
		"https://www.youtube.com/watch?v=qxRVN5LLtFY": "Sharkie's Review",
	},
	...
	systems: "PC",
	urls: {
		"https://www.youtube.com/watch?v=ewDEnp9BF4U": "Sharkie's Review", 
	},
	location: "BIN-03",
	obtained: "2009-09-28",
	photographed: true,
	...
	cost: 15,
	urls: {
		"https://www.youtube.com/watch?v=FgiPAi1y_Ys": "Sharkie's Review", 
	},
	description: `You put a Dualshock 2 in it, and it pushes the buttons`,
	importOnly: true,
},{
	peripheral: "082",
	image: "82.jpg",
...
Somewhat programmable. You select a sensor block (ie: Detect something touching right antennae) and a reaction block (ie: turn left) And you can have it set to move forward if nothing is detected, then allow that action to be interrupted if any other sensor block is triggered`,
	...
	cost: 60,
	urls: {
		"https://www.youtube.com/watch?v=Z8dRdw9iPm4": "Sharkie's Review",
	},
...
Infrared control receptor with scratch-resistant, anti-reflective lens  USB, 4 buttons, a cool box`,
	...
	image: "91.jpg",
	company: "Super Soft",
	peripheralName: "Terminator Hand Grenade Joystick Controller",
	location: "BIN-10",
	...
	photographed: true,
	urls: {
		"https://www.youtube.com/watch?v=sx7yGzh82UY": "Sharkie's Review",
	},
	cost: 35,
	...
	cost: 20,
	urls: {
		"https://www.youtube.com/watch?v=GX7yKG2UZzw": "Sharkie's Review",
	},
...
(SD and HD), true force feedback (recoil), digital thumbstick, laser pointer and X/Y axis calibration dials, turbo switch, 6 buttons (2 triggers, start/select, A/B), takes 2 (USB/XBOX) ports (1 for data, 1 for power)`,
	...
	systems: "PC",
	urls: {
		"https://www.youtube.com/watch?v=aMQ78Wttn7k": "Sharkie's Review",
	},
	obtained: "2010-06-07",
	photographed: true,
	cost: 20,
...
The sword's hilt can be pushed in and rotated as an input, as well as 2 oversized buttons and the Classic controller layout, a cool box`,
	...
	type: "gun",
	urls: {
		"https://www.youtube.com/watch?v=68F7tzJHB6w": "Sharkie's Review (Move Edition)",
	},
	obtained: "2010-08-10",
	photographed: true,
	cost: 65,
	...
	systems: "PS1",
	location: "BIN-12 (Site B)",
	peripheralName: "Sailor Moon - Kids Station",
	obtained: "2010-09-15",
	photographed: true,
	cost: 20,
	urls: {
		"https://www.youtube.com/watch?v=AC8VJCVXAvk": "Sharkie's Review",
	},
	...
	cost: 50,
	urls: {
		"https://www.youtube.com/watch?v=WXCGQuQE4sk": "Sharkie's Review",
	},
...
(1 analog, 1 digital), USB charging, built-in battery, bluetooth, can sync with PSP Go, clamshell casing that must be destroyed to open, Unidextrous, Ambidextrous`,
	...
	cost: 30,
	urls: {
		"https://www.youtube.com/watch?v=4rbt3yWvgh0": "Sharkie's Review",
	},
...
Unidextrous, ambidextrous`,
	...
	cost: 20,
	urls: {
		"https://www.youtube.com/watch?v=3xIU4l8gNkA": "Sharkie's Review",
	},
	...
	peripheral: "124",
	company: "Venom",
	peripheralName: "Mini DDR Fingerpad",
	systems: "PS1/PS2",
	type: "rhythm",
	obtained: "2010-11-15",
	photographed: true,
	cost: 40,
	urls: {
		"https://www.youtube.com/watch?v=diYf-t0XNio": "Sharkie's Review",
	},
...
Batteries not included (each gun takes 4xAAs), a cool box`,
	...
	cost: 28,
	urls: {
		"https://www.youtube.com/watch?v=ET0uwstzO8c": "Sharkie's Review",
	},
...
Construction process write-up Part 2 Part 3 Part 4 Part 5 Part 6 Video`,
	...
	cost: 12,
	urls: {
		"https://www.youtube.com/watch?v=mUVndTvClMI": "Sharkie's Review (Famicom version)",
	},
...
Unidextrous, ambidextrous, As seen on "The World Only God Knows"`,
	...
	cost: 40,
	urls: {
		"https://www.youtube.com/watch?v=dcHjtdWVXO8": "Sharkie's Review",
	},
...
triangle/square (on both sides of the gun) Removable scope (hopefully lets you attach a PSP), a cool box, ambidextrous. (Required a Move and a NavCon)`,
	...
	cost: 18,
	urls: {
		"https://shonumi.github.io/articles/art6.html": "Edge of Emulation",
	},
...
Different modes are triggered by holding Start (Controller mode) Select (Powerpoint Remote mode) or nothing (Mouse mode) while turning it on (The power switch is finicky and only acts as on if you move it almost to the on position, not the whole way)`,
	games: "PC games",
	specificVersion: "Red",
...
There is a hidden USB port on the bottom left-hand corner when looking at the back`,
	...
	photographed: true,
	urls: {
		"https://www.youtube.com/watch?v=PnFFak9h0Io": "Sharkie's Review",
	},
	cost: 15,
	...
	systems: "GEN",
	urls: {
		"https://www.youtube.com/watch?v=jomgWUbtCCM": "Sharkie's Review",
	},
	obtained: "2012-05-08",
	photographed: true,
	cost: 25,
	...
	systems: "PC",
	urls: {
		"https://www.youtube.com/watch?v=bXtF9marQhI": "Sharkie's Review",
	},
	obtained: "2012-06-19",
	photographed: true,
	cost: 10,
	...
	systems: "PC",
	urls: {
		"https://www.youtube.com/watch?v=-sXh5u-ULsY": "Sharkie's Review",
	},
	obtained: "2012-07-04",
	photographed: true,
	cost: 20,
	...
	systems: "PC/PS3/XBOX360/PS4/X1/VitaTV/Android",
	obtained: "2012-07-24",
	photographed: true,
	cost: 70,
...
API to let PC apps send data to the console it's connected to`,
	...
	systems: "PS1",
	urls: {
		"https://www.youtube.com/watch?v=qw1N2DdLVe8": "Sharkie's Review",
	},
	obtained: "2012-10-29",
	photographed: true,
	cost: 0,
	...
	location: "BIN-17",
	urls: {
		"https://www.youtube.com/watch?v=aT6_bYis1ag": "Sharkie's Review",
	},
	obtained: "2012-10-29",
	photographed: true,
	importOnly: true,
	...
	obtained: "2012-10-29",
	urls: {
		"https://www.youtube.com/watch?v=8VeFixJ7DF4": "Sharkie's Review",
	},
	photographed: true,
	cost: "Unknown",
	...
	photographed: true,
	cost: 59,
	description: "A large hard-cover book of 14 augmented reality tracking tags. Cost includes a game, PSeye and Move",
	games: "Harry Potter: Book of Spells, Book of Potions, Walking with Dinosaurs, Diggs Nightcrawler",
},{
	peripheral: "186",
	company: "PowerA",
	peripheralName: "MOGA",
	...
	photographed: true,
	urls: {
		"https://www.youtube.com/watch?v=8sbuuPB-zUI": "Sharkie's Review",
	},
	cost: 12,
	...
	systems: "PS2",
	urls: {
		"https://www.youtube.com/watch?v=VyHtijZlrH4": "Sharkie's Review",
	},
	obtained: "2013-03-11",
	photographed: true,
	cost: 0,
	...
	cost: 20,
	urls: {
		"https://www.youtube.com/watch?v=uHh5PbZ7peQ": "Sharkie's Review",
	},
	specificVersion: "Red",
	otherVersions: "Green",
...
2 triggers, 5 face buttons, 1 clickable analog thumbstick, wired to the base`,
	...
	cost: 5,
	urls: {
		"https://www.youtube.com/watch?v=uzJmWFoV1uM": "Sharkie's Review",
	},
...
The controller uses 2xAAAs (not included) the adapter uses a Y-cord to take power from the PSP's AC adapter`,
	...
	location: "BIN-14",
	urls: {
		"https://www.youtube.com/watch?v=xl5dfSJuFdM": "Sharkie's Review",
	},
	obtained: "2013-08-19",
	photographed: true,
	cost: 0,
	...
	photographed: true,
	urls: {
		"https://www.youtube.com/watch?v=1pDaF-ioHg8": "Sharkie's Review",
	},
	cost: 0,
	importOnly: true,
	description: `6 face buttons, microphone`,
	...
	cost: 0,
	urls: {
		"https://shonumi.github.io/articles/art8.html": "Edge of Emulation",
	},
	...
	peripheral: "216",
	company: "Takara",
	peripheralName: "Multi Plust On System",
	systems: "GBA",
	type: "toys2life",
	obtained: "2013-08-19",
	photographed: true,
	cost: 0,
	urls: {
		"https://shonumi.github.io/articles/art17.html": "Edge of Emulation",
	},
	...
	cost: 0,
	urls: {
		"https://shonumi.github.io/articles/art15.html": "Edge of Emulation",
	},
...
"∞peterpan.jpg",],
	...
	cost: 30,
	urls: {
		"https://www.youtube.com/watch?v=gGrQX01XSSQ": "Sharkie's Review",
	},
	...
	systems: "PC",
	urls: {
		"https://www.youtube.com/watch?v=LU8diWt_j_c": "Sharkie's Review",
	},
	location: "BIN-04",
	obtained: "2014-03-25",
	photographed: true,
...
It's powered which implies it has forcefeed back of some sort (rumble or the ability to turn itself) and what appears to be a light on top`,
	...
	systems: "Wii/Wii U",
	urls: {
		"https://www.youtube.com/watch?v=BsnAcSJE7ho": "Sharkie's Review",
	},
	obtained: "2014-08-26",
	photographed: true,
	cost: 10,
	...
	urls: {
		...
		"https://www.youtube.com/watch?v=nDctGz9FE70": "Sharkie's Review (second model)", 
	},
	obtained: "2014-10-29",
	photographed: true,
	cost: 10,
	...
	urls: {
		"https://www.youtube.com/watch?v=ZX9_5loba54": "Sharkie's Review",
	},
	obtained: "2015-04-19",
	photographed: true,
	cost: 50,
	description: `Ambidextrous (the sticks are swappable!) throttle with 2-way+neutral switch, and button. Joystick with a trigger, button, and switch. 3 face buttons (2 mirror the buttons on the joystick), 2 system buttons, 6 function switches`,
...
Stick: wired to PC via USB, dual-axis joystick, 3 triggers (2 up top, 1 on the bottom for your pinky finger which lights up the F.LOCK LED), 2 dpads, 3 light-up buttons (1 is red and underneath a Suzie-shield, the other 2 are orange)`,
	...
	photographed: true,
	cost: 600,
	description: `HMD: 2 1080×1200 90Hz OLED panels, 110° FOV, headphones with 3D audio, 6-axis motion sensing, uses HDMI and 1 USB 3.0 port, a cool box, bluetooth receiver, USB extension cable
...
Constellation: IR LED sensor to track the HMD`,
	...
	cost: 90,
	urls: {
		"https://www.youtube.com/watch?v=3TC1cPgRpbo": "Sharkie's Review",
	},
	...
	type: "keyboard",
	urls: {
		"https://www.youtube.com/watch?v=xKUOTkSoxzo": "Sharkie's Review",
	},
	obtained: "2016-07-09",
	photographed: true,
	cost: 50,
...
Keyboard: Connects via USB, detachable from the controller, standard QWERTY layout`,
	...
	cost: 550,
	urls: {
		"https://www.youtube.com/watch?v=3-N9eHMlrHw": "Sharkie's Review",
	},
	description: `A 5" 1080p (960×1080 per eye) 90-120Hz OLED RGB screen, 100° FOV, head tracking via LEDs (requires PS Camera to work), microphone, a cool box, headphone port (includes earbuds), inline remote (controls power, microphone, volume +/-), connects via HDMI and USB 3.0, infrared wearer detection
...
4 switches (profiles (1/2/3), console (PS3/PS4/PC), stick alignment (right on kb/left on kb), mode (assign/off/adjust))`,
	...
	attached: "286-A",
	company: "Nintendo",
	peripheralName: "Famicom Classic",
	systems: "SYS",
	obtained: "2023-12-25",
	cost: 0,
	description: "HDMI, powered via microUSB, 2 Wii EXT ports, plays 30 built-in NES games (cannot be expanded) 4 savestates per game, 3 display modes (CRT, 4:3, Pixel Perfect). 2 hard-wired controllers with: dpad, 2 face buttons, 2 system buttons",
	games: "NES Classic",
},{
	peripheral: "287",
	company: "Nintendo",
...
Antlers: Adds LEDs powered by their own battery for motion sensing`,
	...
	systems: "PS1",
	urls: {
		"https://www.youtube.com/watch?v=r6HwTyBNb4o": "Sharkie's Review",
	},
	obtained: "2017-02-22",
	photographed: true,
	cost: 1,
	...
	systems: "PS3/PS4/XBOX360/X1/PSTV/PC/Android",
	obtained: "2017-02-22",
	photographed: true,
	cost: 90,
	image: "302-A.png",
...
Includes: Guitar Connector for Rock Band VR, Constellation sensor, a cool box`,
	...
	systems: "PS3",
	urls: {
		"https://www.youtube.com/watch?v=NNadCvqHtJw": "Sharkie's Review",
	},
	obtained: "2017-03-08",
	photographed: true,
	cost: "Gift",
	...
	cost: 20,
	urls: {
		"https://www.youtube.com/watch?v=cY9lIEpCZYA": "Sharkie's Review (n50)",
	},
...
Both: Wireless via USB dongle. The keyboard and mouse both take 2xAA batteries each (included)`,
	...
	obtained: "2017-04-08",	
	urls: {
		"https://www.youtube.com/watch?v=R5ztXG7hPlM": "Sharkie's Review",
	},
	cost: 80,
	...
	systems: "PC",
	urls: {
		"https://www.youtube.com/watch?v=wKC8ybawOqM": "Sharkie's Review",
	},
	obtained: "2017-05-13",
	cost: 80,
	...
	systems: "PS2",
	urls: {
		"https://www.youtube.com/watch?v=PtUvXiFgGHk": "Sharkie's Review",
	},
	obtained: "2017-05-13",
	cost: 50,
	...
	systems: "PS4",
	urls: {
		"https://www.youtube.com/watch?v=n-p0r2sstrM": "Sharkie's Review",
	},
	obtained: "2017-05-16",
	cost: 60,
	...
	systems: "PS2",
	urls: {
		"https://www.youtube.com/watch?v=cdUxoylGdi8": "Sharkie's Review",
	},
	obtained: "2017-05-18",
	cost: 80,
	description: `Wireless (via USB dongle), dpad, 3 buttons, gyroscope`,
...
Connections for: 5 speakers, 2 TOSlink/optical audio cables, digital coaxial, headphones, composite audio, USB-B`,
	...
	cost: 100,
	urls: {
		"https://www.youtube.com/watch?v=WPhpcMim_w8": "Sharkie's Review",
	},
	importOnly: true,
...
Hold START to pair it`,
	...
	cost: 40,
	urls: {
		"https://shonumi.github.io/articles/art25.html": "Edge of Emulation",
	},
	...
	systems: "PS4",
	urls: {
		"https://www.youtube.com/watch?v=E8QQ7_wZQdM": "Sharkie's Review",
	},
	obtained: "2018-01-25",
	cost: 40,
	location: "BIN-15",
...
https://github.com/shinyquagsire23/Switch-Fightstick`,
	...
	obtained: "1999-04-16",
	cost: 45,
	description: `A Gameboy cartridge with an integrated rumble motor. Takes 1xAAA battery`,
},{
	peripheral: "363-B",
	attached: "363-A",
	type: "forcefeedback",
	...
	company: "Nintendo",
	type: "forcefeedback",
	peripheralName: "Top Gear Rally (JPN)",
	systems: "GBC",
	obtained: "2022-07-22",
	cost: 20,
},{
	...
	type: "forcefeedback",
	company: "Nintendo",
	peripheralName: "3-D Ultra Pinball",
	systems: "GBC",
	obtained: "2023-02-05",
	cost: 30,
},{
	...
	type: "forcefeedback",
	company: "Nintendo",
	peripheralName: "Ready To Rumble Boxing",
	systems: "GBC",
	obtained: "2024-04-25",
	cost: 20,
},{
	...
	type: "forcefeedback",
	company: "Nintendo",
	peripheralName: "Star Wars Episode 1 Racer",
	systems: "GBC",
	obtained: "2024-04-25",
	cost: 20,
},{
	...
	type: "forcefeedback",
	company: "Nintendo",
	peripheralName: "NASCAR Challenge",
	systems: "GBC",
	obtained: "2024-06-07",
	cost: 20,
},{
	...
	company: "Nintendo",
	type: "forcefeedback",
	peripheralName: "Legend Of The River King 4 / 川のぬし釣り4 (JPN)",
	systems: "GBC",
	obtained: "2024-07-01",
	cost: 30,
},{
	...
	type: "forcefeedback",
	company: "Nintendo",
	peripheralName: "Kite's Adventure / Nushi Tsuri Adventure Kite no Bouken / ぬし釣りアドベンチャー カイトの冒険 (JPN)",
	systems: "GBC",
	obtained: "2024-08-02",
	cost: 50,
},{
	...
	peripheralName: "Polaris Snocross",
	systems: "GBC",
	obtained: "2025-04-19",
	cost: 25,
},{
	...
	company: "Nintendo",
	type: "forcefeedback",
	peripheralName: "Missile Command",
	systems: "GBC",
	obtained: "2025-05-21",
	cost: 25,
},{
	...
	type: "forcefeedback",
	company: "Nintendo",
	peripheralName: "Test Drive Off-Road 3",
	systems: "GBC",
	obtained: "2025-05-21",
	cost: 25,
},{
	...
	type: "motion",
	company: "Nintendo",
	peripheralName: "Kirby's Tilt 'n Tumble",
	systems: "GBC",
	obtained: "2025-10-30",
	cost: 5,
},{
...
Variable number of face buttons (2 in NES mode, 4 in SNES/Gamecube/Switchmode, 6 in N64 mode but 2 are mirrors of L2/R2) via removable face button modules held in place by removable face plates`,
	...
	cost: 20,
	urls: {
		"https://shonumi.github.io/articles/art2.html": "Edge of Emulation",
	},
...
The unlock button also sticks out a lot more`,
	...
	peripheral: "391-D",
	images: ["391-eli.jpg", "391-crusher.jpg", "391-hailstorm.jpg"],
	attached: "391-A",
	company: "Ubisoft",
	...
	peripheral: "391-F",
	images: ["391-F.jpg", "391-kharl.jpg", "391-freeze.jpg"],
	attached: "391-A",
	company: "Ubisoft",
	...
	peripheral: "391-G",
	images: ["391-lance.jpg", "391-G.jpg", "391-gauss.jpg"],
	attached: "391-A",
	company: "Ubisoft",
	location: "BIN-07",
	...
	games: "Pokémon: Let's go, Pikachu!, Pokémon: Let's go, Eevee!  (Switch), Pokémon Go (iOS/Android)",
},{
	peripheral: "396",
	company: "GameTech",
	...
	systems: "PC",
	urls: {
		"https://www.youtube.com/watch?v=5ZApOa4nSOA": "Sharkie's Review",
	},
	obtained: "2019-02-25",
	cost: 50,
...
Touchpad area, headphone port`,
	...
	company: "Bandai",
	type: "tamagotchi",
	peripheralName: "Tamagotchi Uni",
	systems: "SYS",
	obtained: "2024-07-27",
	cost: 100,
	location: "BIN-14",
	description: "3 system buttons, rechargeable battery (charges via USB-C), wifi, 128×128 color LCD, wrist strap, a cool box",
	specificVersion: "Sanrio",
},{
	peripheral: "413",
	...
	games: "FidgetlyCTRL (Android/iOS)",
},{
	peripheral: "414",
	company: "Hyperkin",
	...
	games: "Oldboy Gameboy Emulator (Android)",
},{
	peripheral: "415",
	company: "Aduro",
	type: "gun",
	...
	systems: "PC/Android/MAC/Switch/Pi",
	obtained: "2019-08-15",
	section: "pc",
	cost: 50,
...
Cost included $130 for a starter kit (came with 2 lightcons if you preordered), $40 for another Lightcon
	`,
	...
	cost: 50,
	urls: {
		"https://shonumi.github.io/articles/art19.html": "Edge of Emulation",
	},
	...
	company: "LEGO",
	location: "Cheerios Box: 40261",
	peripheralName: "Desert Pokey Expansion Set",
	systems: "misc",
	obtained: "2022-09-23",
	cost: 25,
...
analog triggers, Bluetooth, built in battery, USB-C charging, microphone, mute button, headset port, force feedback triggers, clickable touchpad, speaker`,
	...
	cost: 63,
	urls: {
		"https://www.youtube.com/watch?v=yQmD9ImZMx4": "Sharkie's Review",
	},
	...
	company: "Fun Source",
	type: "proplica",
	peripheralName: "Star Trek TNG: Type I Phaser",
	systems: "PC",
	location: "Cheerios Box: 40261",
	obtained: "2022-02-05",
	cost: 20,
	description: `5 buttons, lights, makes sounds, connects via serial, mechanical/wheeled mouse, requires 1 CR2032 battery`,
},{
	peripheral: "450-A",
	company: "Taito",
	type: "arcade",
	peripheralName: "Egret II Mini",
	systems: "SYS",
	obtained: "2022-03-08",
	cost: 200,
	type: "tate,arcade",
	...
	obtained: "2022-03-08",
	cost: 40,
	description: `a dpad, 6 face buttons, 2 system buttons, 1 OS button, plugs in via USB`,
},{
	peripheral: "451",
	company: "Taito",
	location: "BIN-06",
	type: "mouse",
	peripheralName: "Egret II Paddle + Trackball Controller",
	systems: "EGRET",
	section: "misc",
	obtained: "2022-03-08",
	cost: 100,
	games: "Egret II Mini Paddle + Trackball Controller",
	description: `trackball, wheel/dial, 2 system buttons, 1 OS button, plugs in via USB, trackball and wheel shows up on PC as a mouse but the buttons do not, comes with an SD card with 10 games`,
},{
	peripheral: "452",
	company: "Logitech",
	peripheralName: "Wingman Warrior",
	systems: "PC",
	obtained: "2022-04-16",
	cost: 5,
	description: `analog joystick, 1 trigger, 1 POV hat, 3 buttons, dial, spinner, uses both serial and gameport interfaces`,
},{
	peripheral: "453",
	company: "Azeron",
	...
	obtained: "2022-04-19",
	cost: 200,
	description: `clickable analog thumbstick, clickable  POV hat, uses USB mini (B), profile switch (shows up as 2 logical controllers), 23 buttons, remappable via software
	a cool box, branded screwdriver, all of the knuckles are adjustable`,
},{
	peripheral: "454",
	company: "SEGA",
	type: "arcade",
	...
	description: `698x930 portrait LCD, 2 USB ports, powered via micro USB, HDMI out (480p, 720p), digital joystick, 6 face buttons, 1 OS button, 1 system button, headphone port, LED bar, stereo sound`,
},{
	peripheral: "455",
	company: "Intec Gaming",
	peripheralName: "GBA HDMI Kit",
	systems: "SYS",
	obtained: "2022-08-04",
	cost: 150,
	games: "GB, GBC, GBA",
	description: `A solderless kit to convert an original model GBA into a consolized version with HDMI out and a SNES controller port, and the GBA shell into a SNES controller`,
},{
	peripheral: "456",
	company: "Panic",
	peripheralName: "PlayDate",
	systems: "SYS",
	obtained: "2022-08-09",
	cost: 200,
	games: "PlayDate Games",
	description: `400x240 black or white LCD, mono speaker, dpad, 2 face buttons, 2 OS buttons, analog crank with dock sensor, built-in rechargeable battery (charges via USB-C), wifi, bluetooth, RGB LED, gyro sensor`,
},{
	peripheral: "457",
	company: "Valve",
	type: "tablet",
	peripheralName: "Steam Deck",
	systems: "SYS",
	obtained: "2022-08-22",
	cost: 500,
	games: "Windows games, Linux games",
	specificVersion: "64 GB",
	otherVersions: "256 GB, 512 GB",
	description: `1280x800 LCD, built-in rechargeable battery (charges via USB-C), wifi, bluetooth, a cool case, video-out via USB-C, 2 clickable thumbsticks with a capactive thumb sensor, dpad, 2 system buttons, 5 OS buttons, 4 face buttons, 2 touchpads, rumble/haptics, motion sensing, 8 triggers, stereo sound, SD slot`,
},{
	peripheral: "458",	
	image: "253.jpg",
	company: "SEGA",
	section: "sega",
	type: "simulator",
	peripheralName: "Cyber Stick XE1AK-USB",
	systems: "PC, Genesis Mini II",
	obtained: "2022-11-19",
	photographed: true,
	cost: 200,
	urls: {
		"https://www.youtube.com/watch?v=ZX9_5loba54": "Sharkie's Review (Original Model)",
	},
	description: `Ambidextrous (the sticks are swappable!)  throttle with 2-way+neutral switch, and button. Joystick with a trigger, button, and switch. 3 face buttons (2 mirror the buttons on the joystick), 2 system buttons, 6 function switches, a cool box`,
},{
	peripheral: "459",
	company: "Analogue",
	peripheralName: "Pocket",
	systems: "SYS",
	obtained: "2022-11-19",
	cost: 350,
	games: "GB/GBC/GBA games, other systems with adapters or cores loaded to the SD card",
	specificVersion: "Black",
	otherVersions: "White",
	description: `1600x1440 LCD, built-in rechargeable battery (charges via USB-C), video-out via a dock, dpad, 2 system buttons, 3 OS button, 4 face buttons, 2 triggers, stereo sound, SD slot, cartridge slot`,
},{
	peripheral: "459-d",
	attached: "459",
	company: "Analogue",
	peripheralName: "Pocket Dock",
	systems: "SYS",
	obtained: "2023-08-25",
	cost: 120,
	description: `A dock for the Analogue Pocket, adds HDMI out, bluetooth, 2 USB ports for controllers`,
},{
	peripheral: "459-g",
	attached: "459",
	company: "Analogue",
	peripheralName: "Game Gear Adapter",
	systems: "SYS",
	obtained: "2023-08-25",
	cost: 30,
	description: `An adapter for the Analogue Pocket, adds Game Gear compatibility`,
},{
	peripheral: "459-A",
	attached: "459",
	company: "Analogue",
	peripheralName: "3-pack Adapter set",
	systems: "SYS",
	obtained: "2024-03-12",
	cost: 100,
	description: `Adapters for the Analogue Pocket, adds Neo Geo Pocket/Pocket Color, PC Engine/TurboGrafx, and Atari Lynx compatibility`,
},{
	peripheral: "459-B",
	attached: "459",
	company: "Analogue",
	peripheralName: "Beefy Grip + dock",
	systems: "SYS",
	obtained: "2024-03-12",
	cost: 100,
	description: `A more confortable way to hold the Analogue Pocket`,
},{
	peripheral: "460-A",
	company: "Thunder Stick Studio",
	type: "arcade",
	peripheralName: "Build-a-Cade",
	systems: "SYS",
	obtained: "2022-11-19",
	cost: 100,
	games: "Pi games",
	description: `480x800 LCD, built-in rechargeable battery (charges via USB-C), video-out via HDMI, required a Raspberry Pi 3 or 4, joystick, 2 system buttons, 1 face button, 2 OS buttons, Illuminated marquee, stereo sound, 32GB microSD card`,
},{
	peripheral: "460-B",
	company: "Thunder Stick Studio",
	attached: "460-A",
	type: "arcade",
	peripheralName: "Dual joystick with 3 buttons",
	systems: "Build-a-Cade",
	obtained: "2022-11-19",
	cost: 25,
	games: "Pi games",
	description: `2 joysticks, 2 system buttons, 1 face button`,
},{
	peripheral: "460-C",
	company: "Thunder Stick Studio",
	attached: "460-A",
	type: "arcade",
	peripheralName: "Joystick with 5 buttons",
	systems: "Build-a-Cade",
	obtained: "2022-11-19",
	cost: 25,
	games: "Pi games",
	description: `joystick, 2 system buttons, 3 face buttons`,
},{
	peripheral: "460-D",
	company: "Thunder Stick Studio",
	attached: "460-A",
	type: "arcade",
	peripheralName: "Spinner with 5 buttons and GRS mini steering wheel",
	systems: "Build-a-Cade",
	obtained: "2022-11-19",
	cost: 25,
	games: "Pi games",
	description: `Hall-effect spinner with steering wheel attachment, 2 system buttons, 3 face buttons`,
},{
	peripheral: "460-E",
	company: "Thunder Stick Studio",
	attached: "460-A",
	type: "mouse",
	peripheralName: "Trackball with 5 buttons",
	systems: "Build-a-Cade",
	obtained: "2022-11-19",
	cost: 25,
	games: "Pi games",
	description: `Optical trackball, 2 system buttons, 3 face buttons`,
},{
	peripheral: "461",
	company: "SEGA",
	peripheralName: "Genesis Mini 2",
	systems: "SYS",
	location: "BIN-06",
	obtained: "2022-12-16",
	cost: 150,
	description: "HDMI, powered via microUSB, 2 USB ports, plays 60 built-in Genesis games (cannot be expanded) 4 savestates per game, 2 display modes (4:3, widescreen) + a CRT filter, 1x Genesis 6-button controller replica",
	games: "Genesis Mini 2",
},{
	peripheral: "462",
	...
	obtained: "2022-12-16",
	cost: 150,
	description: `A cool box, 1x USB-C slave port, 2x USB-C master ports, headset port, 2 analog levers with 2x detent buttons each, dpad, 1 clickable analog thumbstick, 1 rotatable Hall-effect joystick, clickable touchpad, 
			LCD, 1 trigger, clickable scrollwheel, dial that is clickable on left/right side for controllers settings, ambidextrous, 10 face buttons (2 on the stick), 2 OS buttons, 2 system buttons, braided USB-C cable`,
},{
	peripheral: "463",
	company: "Sony",
	peripheralName: "DualSense Edge",
	systems: "PS5",
	type: "backbuttons",
	obtained: "2023-01-26",
	cost: 300,
	...
	company: "Logitech",
	type: "simulator",
	peripheralName: "Heavy Equipment Side Panel",
	systems: "PC",
	location: "Cheerios Box: 40237",
	obtained: "2023-02-10",
	cost: 100,
	description: `Desk clamp, 24 face buttons, clickable scroll wheel, twistable analog stick with 2 button (1 of which switches which axis the rotation acts as)`,
},{
	peripheral: "465-A",
	company: "Sony",
	type: "3d",
	peripheralName: "PSVR2 Headset",
	systems: "PS5",
	cost: 800,	
	obtained: "2023-02-22",
	description: "2000x2040 (per eye) 90-120Hz OLED, 110° FOV, microphone, headset port, connects via USB-C, inside-out tracking via 4 cameras, IR eye tracking, haptics, a box",
},{
	peripheral: "465-B",
	attached: "465-A",
	company: "Sony",
	type: "motion",
	peripheralName: "PSVR2 Sense controllers",
	systems: "PS5",
	obtained: "2023-02-22",
	description: "Wireless (via Bluetooth), rechargeable battery (charges via USB-C), 1 clickable analog stick, 2 face buttons, 1 system button, 1 OS button, wrist strap, 2 triggers (1 digital, 1 analog with force feedback), haptics",
},{
	peripheral: "465-C",
	attached: "465-A",
	company: "Sony",
	peripheralName: "PSVR2 PC adapter",
	systems: "PS5",
	cost: 80,
	obtained: "2024-08-07",
	description: "Allows the use of PSVR2 on PCs via SteamVR, uses an AC adapter, requires a DisplayPort cable (not included)",
},{
	peripheral: "466",
	company: "IFYOO",
	peripheralName: "Gaming Touchpad",
	location: "BIN-12 (Site B)",
	systems: "PC",
	obtained: "2023-03-11",
	cost: 50,
	description: "Works as a keyboard+mouse (not a gamepad), digital stick, dpad, 6 triggers, 13 buttons, scroll wheel, clickable touchpad",
	specificVersion: "Pink",
	otherVersions: "Black, Yellow",
},{
	peripheral: "467",
	company: "Mad Catz",
	type: "rhythm",
	peripheralName: "Wireless Keyboard",
	systems: "Wii",
	obtained: "2023-03-11",
	cost: 20,
	description: "Wireless (via USB dongle with 2 extra USB ports), 25 keys, 4 face buttons, dpad, 2 system buttons, 1 OS buttons, touchpad and button",
	games: "Rock Band 3"
},{
	peripheral: "468",
	company: "Blaze",
	peripheralName: "Scarab",
	systems: "PS2",
	urls: {
		"https://www.youtube.com/watch?v=1itdNVDqRNw": "Sharkie's Review",
	},
	location: "BIN-11 (Site B)",
	obtained: "2023-04-08",
	cost: 100,
	description: "A PS2 controller that folds up",
},{
	peripheral: "469",
	company: "WinWing",
	peripheralName: "MFD",
	...
	cost: 300,
	obtained: "2023-04-11",
	description: "1024×767 USB 3.0 LCD (works as a standard display in Windows), 44 buttons (most of which are backlit), 1 dial, 3 position switch",
},{
	peripheral: "470",
	company: "ASCII",
	peripheralName: "Mission Stick",
	systems: "DC",
	type: "simulator",
	cost: 120,
	games: "Aero Dancing/Aerowings, Propeller Arena",
	obtained: "2023-05-21",
	description: "Memory card/rumble slot, analog palm-stick with 3 remappable buttons, 4 face buttons, dpad, 1 system button, 2 analog buttons, turbo settings per button",
},{
	peripheral: "471",
	company: "Sony",
	style: "list",
	...
	cost: 20,
	obtained: "2023-05-23",
	description: "Wireless (via Bluetooth and Infrared), takes 2xAA batteries, LED, dpad, 16 buttons, microphone",
},{
	peripheral: "471-B",
	attached: "471",
	company: "Sony",
	type: "remote",
	peripheralName: "PS2 Remote",
	systems: "PS2",
	cost: 0,
	obtained: "2000-01-01",
	description: "Wireless (via Infrared), takes 2xAA batteries, misc buttons",
},{
	peripheral: "471-C",
	attached: "471",
	company: "Sony",
	type: "remote",
	peripheralName: "PS3 Remote",
	systems: "PS3",
	cost: 40,
	obtained: "2011-11-24",
	description: "Wireless (via Bluetooth), takes 2xAA batteries, misc buttons",
},{
	peripheral: "471-D",
	attached: "471",
	company: "Sony",
	type: "remote",
	peripheralName: "PS3 Remote 2",
	systems: "PS3",
	cost: 0,
	obtained: "2025-04-19",
	...
	company: "Konami",
	type: "rhythm",
	peripheralName: "DDR Fingerpad",
	systems: "GBC",
	cost: 50,
	obtained: "2023-06-10",
	description: "Presses Up/Left/A/B",
},{
	peripheral: "473",
	company: "Optec",
	location: "BIN-10",
	peripheralName: "Super Pro Commander",
	systems: "PS1",
	cost: 10,
	obtained: "2023-06-21",
	description: "dpad, 2 system buttons, 4 face buttons, 4 shoulder buttons, LCD, 5 other buttons",
},{
	peripheral: "474",
	company: "Kano",
	location: "Cheerios Box: 40261",
	peripheralName: "Frozen 2: Coding Kit",
	systems: "PC, iOS",
	section: "PC",
	cost: 5,
	obtained: "2023-06-23",
	description: "distance and direction IR sensor",
},{
	peripheral: "475",
	company: "Nintendo",
	peripheralName: "Personal Trainer: Walking",
	systems: "DS",
	location: "Cheerios Box: 40261",
	cost: 10,
	obtained: "2023-07-18",
	description: "A pedometer that interfaces with the game card via built-in InfraRed",
},{
	peripheral: "476",
	company: "Interact",
	...
	location: "Cheerios Box: 40261",
	obtained: "2023-08-05",
	description: "A cartridge with a built-in modem",
},{
	peripheral: "477",
	company: "Nokia",
	peripheralName: "N-gage",
	systems: "SYS",
	cost: 100,	
	specificVersion: "QD",
	otherVersions: "Classic, QD Silver",
	obtained: "2023-08-05",
	description: "176x208 LCD, dpad, Bluetooth, 16 buttons",
},{
	peripheral: "478",
	company: "SEGA",
	type: "camera",
	location: "Cheerios Box: 40261",
	peripheralName: "DreamEye",
	systems: "DC",
	cost: 100,	
	obtained: "2023-08-25",
	description: "640x480 camera, takes 2xAA batteries when not connected to a DreamCast",
},{
	peripheral: "479-A",
	image: "479.jpg",
	title: "Keyboard Extensions",
	style: "list",
	type: "handicap",
	company: "8bitdo",
	peripheralName: "Super Buttons",
	systems: "PC",
	cost: 20,	
	obtained: "2023-10-10",
	...
	company: "8bitdo",
	type: "handicap",
	peripheralName: "Super ABXY",
	systems: "PC",
	cost: 15,	
	obtained: "2024-07-27",
	description: "4 keyboard buttons, magnets to attach to other extensions",
},{
	peripheral: "479-C",
	attached: "479-A",
	company: "8bitdo",
	peripheralName: "Super Stick",
	type: "handicap",
	systems: "PC",
	cost: 15,	
	obtained: "2024-07-27",
	description: "1 joystick, magnets to attach to other extensions",
},{
	peripheral: "479-D",
	attached: "479-A",
	image: "479.D.jpg",
	company: "8bitdo",
	type: "handicap",
	peripheralName: "Super Button",
	systems: "PC",
	cost: 10,	
	obtained: "2024-07-27",
	description: "1 big button, magnets to attach to other extensions",
	specificVersion: "Blue",
	...
	specificVersion: "Black",
	otherVersions: "White",
	description: "128x64 monochrome LCD, compatible with DreamCast as a VMU, SD card slot, USB-C port for both charging and PC connectivity, built-in rechargeable battery",
},{
	peripheral: "481",
	company: "Microsoft",
	peripheralName: "Kinect 2",
	systems: "X1",
	type: "camera",
	cost: 80,	
	obtained: "2023-10-28",
	description: "1080p infrared depth-sensing camera with microphone",
},{
	peripheral: "482",
	company: "Avotro",
	peripheralName: "Avotro",
	systems: "PC",
	cost: 100,	
	obtained: "2023-11-02",
	description: "A carrying pouch, 2 clickable analog sticks, 2 triggers, 1 dpad, 4 face buttons, 2 system buttons that when pressed together act as an OS button, made for mounting on an exercise bike's handle bar",
},{
	peripheral: "483",
	company: "Limited Run Games",
	type: "tate",
	peripheralName: "Switch Arcade Peripheral",
	systems: "Switch",
	specificVersion: "Espgaluda II (Yellow)",
	otherVersions: "DoDonPachi Resurrection (Red), Mushihimesama (Purple)",
	cost: 60,	
	obtained: "2023-11-11",
	description: "A stand resembling an arcade cabinet, for the Switch (LCD or OLED, not Lite) in Tate/Portrait orientation",
},{
	peripheral: "484",
	company: "Sony",
	peripheralName: "PlayStation Portal",
	systems: "PS5",
	cost: 300,	
	obtained: "2023-11-15",
	description: '1920x1080 8" touchscreen LCD, same inputs as a DualSense, wifi, built-in rechargable battery (charges via USB-C), headphone port',
},{
	peripheral: "485",
	company: "Blaze Entertainment",
	peripheralName: "Evercade EXP",
	systems: "SYS",
	obtained: "2023-11-18",
	cost: 200,
	type: "tate,portable",
	...
	peripheral: "486",
	company: "Sony",
	peripheralName: "Access Controller",
	systems: "SYS",
	type: "handicap",
	obtained: "2023-12-16",
	cost: 130,
	...
	peripheral: "487",
	company: "Miller",
	peripheralName: "Lite Cantroller",
	systems: "PC",
	type: "proplica",
	obtained: "2024-01-09",
	cost: 500,
	description: "dpad, 4 face buttons, 2 system buttons, rechargeable battery (charges via micro-USB), bluetooth only, a cool box, beer",
	games: "Most PC games",
	files: {
		'Manual': "Cantrollerguide.pdf"
	},
},{
	peripheral: "488",
	peripheralName: "Arrow",
	company: "Yawman",
	location: "BIN-16",
	type: "simulator",
	systems: "PC",
	obtained: "2024-03-12",
	cost: 250,
	description: `dpad with center button, thumbstick, POV hat, 6 face buttons, 2 shoulder buttons, 2 mechanically connected triggers, 2 throttle sliders, scroll wheel, 2 pull out things, wired via USB-C`,
},{
	peripheral: "489",
	peripheralName: "Interlink DX",
	company: "Horizon",
	type: "simulator",
	systems: "PC",
	obtained: "2024-03-12",
	cost: 100,
	description: `2 2-way switches, 5 3-way switches, clickable scroll wheel, 1 trigger, 2 tiny dial-triggers, 4 2-way buttons, 2 face buttons, 1 dial, 2 SPIKED analog sticks (1 of which doesn't recenter vertically and is inverted)`,
},{
	peripheral: "490",
	peripheralName: "Flight Yoke",
	company: "Saitek",
	type: "simulator",
	systems: "PC",
	obtained: "2024-04-19",
	cost: 150,
	description: `Yoke: 3 2-way switches, 1 3-way switch (right trigger position), POV hat, yoke (steering wheel with in/out), 1 trigger, 1 face button, 3 buttons for the digital timer, 1 PS/2 connector (for the Throttle Quadrant), 3 USB-A ports
	Throttle Quadrant: 3 levers, 3 2-way buttons, plugs in via a PS/2 connector`,
},{
	peripheral: "491",
	peripheralName: "Ochanoma Battle Set",
	games: "OCHA NO MA BATTLE",
	company: "HORI",
	location: "BIN-15",
	systems: "PS1",
	obtained: "2024-05-15",
	japanese: "パーコンシリーズ お茶の間バトル",
	cost: 115,
	description: `4 controllers with 3 buttons each. 1 plugs into the console, the rest plug into that controller via headphone connectors`,
},{
	peripheral: "492",
	peripheralName: "SpaceBall 5000",
	company: "3DCONNEXION",
	systems: "PC",
	obtained: "2024-07-13",
	cost: 35,
	description: `12 buttons, connects via USB, an orb that can be pushed in 4 directions (up/down/left/right) and twisted slightly in 2 (clockwise/counter-clockwise)`,
},{
	peripheral: "493",
	peripheralName: "e-Swap",
	games: "Racing games",
	company: "Thrustmaster",
	type: "racing",
	systems: "PC/X1",
	...
	cost: 99,
	location: "BIN-14",
	specificVersion: "Forza",
	section: "xbox",
	otherVersions: "Many colors, PS4",
	...
	location: "BIN-15",
	urls: {
		"https://shonumi.github.io/articles/art13.html": "Edge of Emulation",
	},
	description: `A sonar fish-finder that only works on GB, GB Pocket and GB Light (Not Super GB, GBC, GBA/GBplayer or even Analogue Pocket) Takes 4xAAA batteries`,
},{
	peripheral: "496",
	peripheralName: "VirtuReal Racing System",
	company: "Carrera",
	systems: "GBA",
	games: "Carrera Power Slide",
	urls: {
		"https://shonumi.github.io/articles/art24.html": "Edge of Emulation",
	},
	obtained: "2024-08-04",
	cost: 150,
	type: "racing",
  ...
  `,
	...
	location: "BIN-15",
	type: "comms",
	peripheralName: "Four Player Adapter",
	company: "Nintendo",
	section: "nintendo",
	obtained: "2025-07-01",
	cost: 15,
	description: `Allows some Game Boy games to have 4 player support`,
},{
	peripheral: "511",
	systems: "PECE",
	section: "systems",
...
Third-party devices support: 6"~7" screen with DisplayPort over USB-C (Maximum device height support : 115mm)`,
	...
	type: "comms",
	style: "list",
	peripheralName: "GCN Modem",
	systems: "GCN",
	description: `A modem for the GameCube`
},{
	peripheral: "526-B",
	attached: "526-A",
	company: "Nintendo",
	type: "comms",
	peripheralName: "GCN Broadband Adapter",
	systems: "GCN",
	description: `An ethernet adapter for the GameCube`
},{
	peripheral: "526-C",
	attached: "526-A",
	company: "Nintendo",
	type: "comms",
	peripheralName: "Wireless Adapter",
	systems: "GBA",
	obtained: "2004-09-07",
	description: `Plugs into the EXT port of a GBA to allow for wirless communications with other GBAs`
},{
	peripheral: "526-D",
	attached: "526-A",
   ...
   SuperDock (still under construction): 4 USB ports, CD drive (tray), slot for an NVME SSD`,
	...
	company: "Retro Remake",
	section: "systems",
	peripheralName: "N64 SNAC adapter",
	cost: 10,
	obtained: "2026-07-15",
	description: `Allows native use of 4 N64 controllers (and accessories that plug into the slot on the bottom of them) on an FPGA system equipped with a USB SNAC port (ie: The SuperStation Dock)`,
},{
	peripheral: "528-D",
	attached: "528-A",
	company: "Retro Remake",
	section: "systems",
	peripheralName: "SNES SNAC adapter",
	cost: 10,
	obtained: "2026-07-15",
	...
	peripheral: "537",
	company: "ASCII",
	peripheralName: "Hoshizora Navi",
	systems: "DS",
	obtained: "2026-04-25",
	cost: 45,
	description: `An extra-long DS cart to make room for motion sensors`,
},{
	peripheral: "538",
	company: "SplitFish",
	peripheralName: "eyeFX 3D",
	systems: "PS2",
	games: "Ace Combat 5, Drop Ship, Matrix, Tomb Taider, Time Splitters",
	obtained: "2026-04-25",
	type: "3D",
	cost: 10,
	description: `A device that plugs into the controller port, and jiggles the right analog stick in sync with active shutter glasses to simulate 3D`,
},{
	peripheral: "539",
	company: "Intec Gaming",
	...
	cost: 220,
	type: "gun",
	description: `Wireless (via separate dongles for PS1 and PS2), rechargeable battery (charges via USB-C), trigger, rumble, analog stick, 3 buttons, 2 mode switches (one controls rumble, another rapid fire), RGB lighting to indicate power remaining`,
},{
	peripheral: "540",
	company: "Limited Run Games",
	peripheralName: "SNES rumble controller",
	systems: "SNES",
	type: "forcefeedback",
	obtained: "2026-04-25",
	cost: 45,
